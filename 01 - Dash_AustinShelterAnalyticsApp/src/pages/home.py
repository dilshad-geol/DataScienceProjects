        ...
        dbc.Card(
            dbc.CardBody(
                [
                    ...
                    html.P("Average No. of days spent in shelter", className="card-text",),
                ]
            )
        ),
        dbc.Card(
...
layout = html.Div(
    [
        html.H1("Austin Animal Shelter Analytics App"),
        ...
        html.P('''Created By:   Dilshad Raza'''),
        html.H2('Proudly made with Dash from plotly'),
        html.Div(
